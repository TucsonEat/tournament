...
const storage = {
  ...
  async set(key, value) {
    ...
    memStore[key] = value; return { key, value };
  },
  async delete(key) {
    if (typeof window !== "undefined" && window.storage) return window.storage.delete(key, false);
    delete memStore[key]; return { key, deleted: true };
  },
};
